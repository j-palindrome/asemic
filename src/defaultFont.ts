...
export class AsemicFont {
  ...
  parseCharacters(chars: AsemicFont['characters']) {
    for (let name of Object.keys(chars)) {
      const reservedCharacters = ['START', 'END', 'EACH']
...
export class DefaultFont extends AsemicFont {
  constructor(parser: Parser) {
    super(parser, {
      ...
      e: () => parser.hex('1,-.7 @1/4,.4 1,.3').line('<0 <.5'),
      f: () =>
        parser
          .to('+.25,0')
      ...
      m: () =>
        parser
          .line('0,0 0,-1')
          .line('+0,0 +.25,-.2 +.25,.2 .5,0')
          .line('<.65 +.25,-.2 +.25,.2 1,0'),
      n: () =>
        parser
          .line('0,0 0,-1')
      ...
      y: () => parser.line('0,1 1,-1').line('<0.5 0,-1'),
      z: () => parser.line('0,-1 +1,0').line('1,-1 0,0').line('0,0 +1,0'),
      A: () => parser.line('0,0 .5,-2').line('.5,-2 1,0').line('<.5 +-.5,0'),
      ...
      J: () => parser.line('1,-2 1,0 0,0 0,-1').line('<0 +-.5,0'),
      ...
      R: () => parser.line('0,0 0,-2').squ('+0,0 +0,1 -1').line('<.8 1,0'),
      ...
      Y: () => parser.line('.5,0 +0,-1').line('+0,0 0,-2').line('<0 1,-2'),
